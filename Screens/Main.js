...
import { Ionicons,MaterialCommunityIcons ,AntDesign ,MaterialIcons,SimpleLineIcons} from '@expo/vector-icons';
...
import Chat from './Chat';
  ...
  const NarBar = () => {
    ...
    return (
        <Tab.Navigator backBehavior="none" tabBarOptions={{activeTintColor: '#e91e63',showLabel: false, }}>
          <Tab.Screen backBehavior="none" name="Home" component={Home} options={{tabBarIcon: ({ color, size }) => (<SimpleLineIcons name="home" color={color} size={size} />),}}/>
